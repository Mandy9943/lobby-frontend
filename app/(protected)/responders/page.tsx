...
const responders = [
  {
    ...
    message:
      "Thanks for reaching out. I'm interested in learning more about your product. Can we schedule a demo next week?",
  ...
  },
  {
    ...
    jobTitle: "CTO",
    message:
      "Your product looks interesting, but we're currently using a competitor's solution. What makes your offering unique?",
  ...
  },
  {
    ...
    message:
      "This sounds promising. Please send more details about your enterprise pricing and integration capabilities.",
...
export default function Responders() {
  ...
  const uniqueCampaigns = [
    "All",
    ...Array.from(new Set(responders.map((r) => r.campaign))),
  ];
      ...
      {filteredResponders.length === 0 && (
        <div className="text-center py-10">
          <p className="text-muted-foreground">
            No responders found. Try adjusting your search or filters.
          </p>
        </div>
      )}
    </div>
